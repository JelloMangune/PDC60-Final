...
namespace PDC60_FinalProject
{
    ...
    {
        public const string class_retrieve = "http://172.20.64.1/pdc60-final/class-readall.php";
        public const string class_delete = "http://172.20.64.1/pdc60-final/class-delete.php";
